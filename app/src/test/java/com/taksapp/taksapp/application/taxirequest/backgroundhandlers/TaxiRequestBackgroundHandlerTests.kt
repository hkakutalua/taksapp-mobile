...
//import com.taksapp.taksapp.data.cache.SharedPreferencesTaxiRequestCache
...
//    private lateinit var sharedPreferencesTaxiRequestCache: SharedPreferencesTaxiRequestCache
...
//    @Before
//    fun beforeEachTest() {
//        sharedPreferencesTaxiRequestCache = SharedPreferencesTaxiRequestCache(context)
...
//
//            val savedTaxiRequest = sharedPreferencesTaxiRequestCache.getCached()
...
//            whenever(taxiRequestService.getCurrentTaxiRequest())
//                .thenReturn(Result.success(acceptedTaxiRequest))
//            sharedPreferencesTaxiRequestCache.saveToCache(cachedTaxiRequest)
//
//            EventBus.getDefault().register(taxiRequestStatusEventHandler)
//
//            // Act
...
//            sharedPreferencesTaxiRequestCache.saveToCache(sameTaxiRequest)
//
//            EventBus.getDefault().register(taxiRequestStatusEventHandler)
//
//            // Act
